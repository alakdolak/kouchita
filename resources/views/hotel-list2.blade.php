...
<div id="alarm"
     style="background-color: #000000bd; position: fixed; width: 100%; height: 100%; z-index: 999; display: none;">
    <span class="ui_overlay ui_modal editTags getAlarm " style="padding: 10px 10px 20px !important; z-index: 1000;">
        <div class="shTIcon clsIcon closeXicon2" style="float: left;" onclick="closeAlarm()"></div>
        ...
        <div class="ui_column ui_picker alarmBoxCityName" style="padding: 0px;">
        ...
        {{--</div>--}}
        <div class="ui_input_checkbox filterItem lhrFilter filter establishmentTypeFilters establishmentTypeFilters_10591 selected 0 index_0 alwaysShowItem" style="margin: 10px 0px;">
            <input type="checkbox" id="otherOffers" name="otherOffer" value="سایر پیشنهادات"/>
            <label for="otherOffers" style="color: #2c2c2c; font-weight: 300; font-size: 15px;"><span></span>&nbsp;&nbsp; سایر پیشنهادات را نیز به من اطلاع دهید </label>
        </div>
        <div style="display: flex; flex-direction: row; align-items: center; margin-top: 10px; margin-left: 10px;">
            @if(!Auth::check())
                <div class="ui_column ui_picker alarmBoxCityName" style="width: 60% !important; display: inline-block; padding: 0px;">
