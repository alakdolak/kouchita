                                                ...
                                                <div class="overviewContent">
                                                    <div class="ui_columns is-multiline is-mobile reviewsAndDetails"
                                                        ...
                                                        <div class="ui_column  is-12"
                                                             style="border-bottom: 2px solid #e5e5e5; margin-top: 20px">
                                                            <div class="block_header tourBlockHeaders"
                                                                 style="border: none; padding: 0 0 7px 0; margin: 0 ">
                                                                <h3 class="block_title inline-block full-width"
                                                                    style="padding-bottom: 5px; font-size: 18px">لوازم ضروری </h3>
                                                            </div>
                                                            <div class="ui_column  is-12"
                                                                 style="border-bottom: 2px solid #e5e5e5; margin-top: 20px">
                                                                <div class="block_header tourBlockHeaders"
                                                                     style="border: none; padding: 0 0 7px 0; margin: 0 ">
                                                                    <h3 class="block_title inline-block full-width"
                                                                        style="padding-bottom: 5px; font-size: 18px">لوازم پیشنهادی
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="content_column ui_column is-12">
                                                    <div class="ppr_rup ppr_priv_location_nearby">
                                                        <div class="nearbyContainer outerShell block_wrap">
                                                            ...
                                                            <div class="ui_columns neighborhood inline-block full-width"
                                                ...
                                                <div id="ansAndQeustionDiv" class="ppr_rup ppr_priv_location_qa"
                                                    ...
                                                    <div data-tab="TABS_ANSWERS" class="block_wrap" style="position: relative">
                                                        ...
                                                        <span class="ui_button primary fr" onclick="showAskQuestion()"
                                                              style="float: left;">سوال بپرس</span>
                                                                <div id="helpSpan_14" class="helpSpans hidden row">
                                                                    <span class="introjs-arrow"></span>
                                                                    <p>اگر سوالی دارید با فشردن این دکمه از دوستانتان بپرسید تا شما را
                                                                        یاری
                                                                        کنند.</p>
                                                        ...
                                                        <div style="max-width: 60%; float: right; direction: rtl;"
                                                            ...
                                                            <div class="askExplanation">سوال خودتو بپرس تا کسانی که می دونند کمکت کنند.
                                                            </div>
                                                            ...
                                                            <span class="ui_button primary formSubmit"
                                                                  onclick="askQuestion()">ثبت</span>
                                                        ...
                                                        <div class="block_body_top" style="position: relative">
                                                            ...
                                                            <div class="prw_rup prw_common_location_topic" style="position: relative">
                                                                <div style="direction: rtl; position: relative"
                                                                     class="question is-mobile ui_column is-12"
                                                                     id="questionsContainer"></div>
                                                            </div>
