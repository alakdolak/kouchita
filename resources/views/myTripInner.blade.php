                ...
                success: function (response) {
                    ...
                    for(i = 0; i < response.length; i++) {
                        ...
                        if(response[i]["delete"] == 1) {
                            newElement += "<button style='margin-right: 10px;padding: 0 9px;' class='ui_button secondary' onclick='deleteMember(\"" + response[i]['username'] + "\")' data-toggle='tooltip' title='حذف عضو'><span class='' style=''><img src='" + homePath + "/images/deleteIcon.gif'/> </span></button>";
                            if (owner == 1) {
