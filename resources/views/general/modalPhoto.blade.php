...
<div class="modal fade showingPhotosModal" id="photoAlbumModal" role="dialog">
    <div class="modal-dialog" style="margin-bottom: 0px; margin-top: 5px">
        <div class="modal-content" style="background-color: #141518; border: none;">
            ...
            <div class="display-flex">
                ...
                <div id="sidePhotoModal" class="col-xs-12 col-sm-3 rightColPhotosModalMainDiv" style="max-height: 70vh;">
