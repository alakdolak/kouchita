...
<div class="ui_container cpBody">
    ...
    <div class="row">
        <div class="col-lg-3 text-align-right  pd-0" style="float: left;">
            <div class="postsMainDivInSpecificMode col-xs-12 cpBorderBottom pd-0">
                <div class="col-xs-12 postMainDivShown float-right position-relative pd-0">
