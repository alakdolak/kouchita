        ...
        <div>
            <div class="footerRside">
                <div id="aboutShazde" class="aboutShazdeMoreLess">
                    ...
                    <div>
                        کوچیتا،2 پلتفرم و شبکه‌ای اجتماعی در حوزه گردشگری است که با هدف ارتقاء سواد گردشگری، افزایش کیفیت سفر و سهولت استفاده افراد جامعه، اعم از داخلی و بین‌المللی، از خدمات گردشگری ایجاد شده است.
