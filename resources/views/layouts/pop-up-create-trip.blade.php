...
<div id="pop-up-create-trip" class="ui_modal_card saves-settings-modal create-trip-modal is-active" style="z-index: 1000000000001; visibility: hidden">
    ...
    <div class="modal-card">
        ...
        <div class="modal-card-body" style="direction: rtl">
            ...
            <div class="trip-dates ui_columns">
                <div class="ui_column " style="width: 50%;float: right;">
        ...
        <div style="margin-top: 10px">
            <h5 style="float: right; padding: 10px; color: #963019" id="error"></h5>
        </div>
    </div>
</div>