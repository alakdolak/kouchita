            ...
            <div class="global-nav-top">
                <div class="global-nav-bar global-nav-green" id="nav-bar-phone-main-div">
                    <div class="ui_container global-nav-bar-container">
                        ...
                        <a href="{{route('main')}}" class="global-nav-logo" ><img src="{{URL::asset('images/logo.svg')}}" alt="شازده مسافر" class="global-nav-img global-nav-svg" style="height: 10vh !important;width: 210px !important;"/></a>
