...
<link rel='stylesheet' type='text/css' href='{{URL::asset('css/theme2/recentlyViewAndMyTripsInDetails.css')}}' />
                        ...
                        <div>
                            ...
                            @foreach($trips as $trip)
                                <div onclick="document.location.href = '{{route('tripPlaces', ['tripId' => $trip->id])}}'" class="trip-images ui_columns is-gapless is-multiline is-mobile">
                                    @if($trip->placeCount > 0)
                                        <div class="trip-image ui_column is-6 backBackground" style="background: url('{{$trip->pic1}}')"></div>
                                    @else
                                        <div class="trip-image trip-image-empty ui_column is-6 regularBackground"></div>
                                    @endif
                                    @if($trip->placeCount > 1)
                                        <div class="trip-image ui_column is-6 backBackground" style="background: url('{{$trip->pic2}}')"></div>
                                    @else
                                        <div class="trip-image trip-image-empty ui_column is-6 regularBackground"></div>
                                    @endif
                                    @if($trip->placeCount > 2)
                                        <div class="trip-image ui_column is-6 backBackground" style="background: url('{{$trip->pic3}}')"></div>
                                    @else
                                        <div class="trip-image trip-image-empty ui_column is-6 regularBackground"></div>
                                    @endif
                                    @if($trip->placeCount > 3)
                                        <div class="trip-image ui_column is-6 backBackground" style="background: url('{{$trip->pic4}}')"></div>
                                    @else
                                        <div class="trip-image trip-image-empty ui_column is-6 regularBackground"></div>
                                    @endif
                                </div>
                                ...
                                @if($trip->to_ != "" && $trip->from_ != "")
                                    <div class="create-trip-text">{{convertStringToDate2($trip->to_)}}
                                        <p>الی</p>
