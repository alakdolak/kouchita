<div class="bottomLightBorder headerFilter">
    <div style="display: flex; justify-content: space-between;">
        ...
        <span onclick="showMoreItems(0)" class="moreItems0 moreItems">{{__('نمایش کامل فیلترها')}}</span>
        <span onclick="showLessItems(0)" class="lessItems hidden extraItem0">{{__('پنهان سازی فیلتر‌ها')}}</span>
    </div>
