                 ...
                 <div class="template itemRow loading">
                     <div class="row" style="margin: 0; padding: 15px;">
                         <div class="col-xs-6" style="padding: 15px 30px 15px 15px;">
                            ...
                            <div class="epTitle"><div class="icons epInputIconRequired redStar"></div>انتخاب دسته</div>
                            <div>
                                ...
                                <div style="display: inline-block">دسته یک</div>
                            </div>
                                <div style="width: 40%; display: inline-block;">
                                <div style="display: inline-block">
                                    <input onclick="filter()" id="22" type="checkbox">
                                    <label for="22">
                                        <span></span>
                                    </label>
                                </div>
                                <div style="display: inline-block">دسته دو</div>
                            </div>
                            </div>
                            <div class="epBlackNotice">در صورت نبود دسته موردنظر خود در بالا، آن را اضافه نمایید.</div>
                           <div>
                               <div class="epInputBox">
                                   <input class="epInputBoxInput">
                               </div>
                               <button class="btn epAddPlace" data-toggle="tooltip" data-placement="top" title="اضافه کردن مکان جدید">اضافه کن</button>
                           </div>

                            <div class="epRedNotice">سعی کنید کلمات انتخابی کلی باشد</div>
                            <div>
                               <div class="epTitle">توضیحات</div>
                               <textarea class="epAddresText" placeholder="توضیحات همراه با عکس برای دوستانتان نمایش داده می شود.           حداقل 100 کاراکتر"></textarea>
                            </div>
                         ...
                         <div class="col-xs-6" style="padding: 15px 15px 15px 30px; border-left: 1px solid #cccccc;">
                             <div class="epPicBox" style="width: 232px">
                                 ...
                                 <div class="step6picText">قاب مربع</div>
                                 <div class="epEditPicText" onclick="doEdit(213 / 168)" style="cursor: pointer;">ویرایش</div>
                             </div>
                             ...
                             <div class="epPicBox" style="width: 119px;">
                                 ...
                                 <div class="epPicText">قاب مستطیل</div>
                                 <div class="epEditPicText" onclick="doEdit(1)" style="cursor: pointer;">ویرایش</div>
                             </div>
                         </div>
                             ...
                             <div class="termsLabel" style="width: 92%; display: inline-block;">
                                 <div>
                                     <div style="float: right">
                                         <input onclick="filter()" id="23" type="checkbox">
                                         <label for="23">
                                             <span></span>
                                         </label>
                                     </div>
