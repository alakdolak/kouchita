...
@section('header')
    ...
    <link rel="stylesheet" href="{{URL::asset('css/theme2/souvenirDetails.css')}}">
                        ...
                        <div class="meta_inner">
                            <div class="ppr_rup ppr_priv_hr_atf_north_star_traveler_info_nostalgic">
                                <div class="metaDatePicker easyClear">
                                    ...
                                    {{--</div>--}}
                                    {{--</div>--}}
                                    <div class="souvenirGeneralDetail full-width">
                                        <div class="col-xs-5">
                                            <div>
                                                <span>دسته:</span>
                                        ...
                                        <div class="col-xs-7">
                                            <div>
                                                <span>زمان مصرف:</span>
                                                <span>محدود / فاسد شدنی</span>
                                            </div>
                                            <div>
                                                <span>ابعاد جابجایی:</span>
                                                <span>کوچک</span>
                                            </div>
                                            <div>
                                                <span>تعداد تولیدکنندگان موجود:</span>
                                                <span>10 واحد</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="souvenirGeneralDetail full-width">
                                        <b class="full-width inline-block">مصارف</b>
                                        <span>برای خوردن و مهمانی بردن که بسیار هم جالب است.</span>
                                    </div>
                                    <div class=" souvenirGeneralDetailTexts">
                                        <b>معرفی کلی</b>
                                        <p>
                                ...
                                <div class="prw_rup prw_common_mercury_photo_carousel">
                                    <div class="carousel bignav" style="max-height: 338px;">
                                        <div class="carousel_images carousel_images_header">
                                            <div class="siteSelectionBadge circleBase type2"></div>
                                            <div class="siteSelectionBadgeText">
                                                منتخب
                                                <br>
                                                شازده
                                            </div>
        ...
        <div id="MAIN" class="Hotel_Review prodp13n_jfy_overflow_visible" style="position: relative;">
            <div id="BODYCON" ng-app="mainApp"
                ...
                <div class="col-xs-12 menu"
                    ...
                    <div class="col-xs-2"><a href="#nearbyDiv">مکان های نزدیک</a></div>
                    <div class="col-xs-2"><a href="#photosDiv">عکس ها</a></div>
                    {{--@if($placeMode == "hotel")--}}
                    <div class="col-xs-2"><a href="#similars">هتل های مشابه</a></div>
                        ...
                        <div class="block_wrap" data-tab="TABS_OVERVIEW">
                            ...
                            <div class="overviewContent">
                                <div class="ui_columns is-multiline is-mobile reviewsAndDetails" style="direction: ltr;">
                                    <div class="ui_column is-12 details">
                                        <div class="prw_rup prw_common_atf_header_bl souvenirMainTextBoxes">
                                            <b>معرفی کلی</b>
                                            <span>
                                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطر آنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می‌باشد.
                                            </span>
                                        ...
                                        <div class="prw_rup prw_common_atf_header_bl souvenirProviderMainDiv full-width">
                                            <div class="souvenirProviderFiltration inline-block full-width">
                                                <b class="col-xs-2 inline-block right">ارائه دهندگان</b>
                                                <b class="col-xs-2 inline-block right">مرتب‌سازی براساس</b>
{{--                                                <select>--}}
{{--                                                    <option disabled selected hidden value="">شهر:انتخاب کنید</option>--}}
{{--                                                    <option>همه <span>200</span></option>--}}
{{--                                                </select>--}}
                                                <div class="col-xs-2 inline-block right">
                                                    <span>شهر:انتخاب کنید
                                                        <span class="glyphicon glyphicon-triangle-bottom dropdownMenu"></span>
                                                    </span>
                                                    <div id="souvenirProviderCityFiltration">
                                                        <div>همه
                                                            <span>200</span>
                                                        </div>
                                                        <div>اصفهان
                                                ...
                                                <span class="col-xs-2 inline-block right">بهترین بازخورد</span>
                                                <span class="col-xs-2 inline-block right">پیشنهادات ویژه</span>
                                                <div class="col-xs-2 inline-block right">
                                                    <span>کمترین فاصله تا
                                                        <span class="glyphicon glyphicon-triangle-bottom dropdownMenu"></span>
                                                    </span>
                                                    <div id="souvenirProviderMinimumDistanceFiltration">
                                                        <input type="text" placeholder="مکان مورد نظر را وارد کنید" class="full-width">
                                                        <span class="full-width inline-block">توجه کنید این مکان باید در محدوده‌ی استان باشد</span>
                                                        <span class="inline-block">متأسفانه مکان مورد نظر در دسترس نمی‌باشد</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <script>
                                            ...
                                            <center>
                                                <div class="col-xs-3 right souvenirProviderDetailsMainDiv">
                                                    <div class="souvenirProviderExp inline-block full-width">
                                                        <center class="inline-block full-width">
                                                            <center class="souvenirProviderLogo circleBase type2"></center>
                                                        </center>
                                                        <center class="souvenirProviderName">
                                                    ...
                                                    <div>
                                                        <div class="blEntry address full-width rtl" style="white-space: normal;">
                                                            <span class="ui_icon map-pin"></span>
            ...
            {{--                                            @if(!empty($place->phone))--}}
                                                        <div class="blEntry phone full-width rtl">
                                                            <span class="ui_icon phone" ></span>
                                                            <span style="font-size: 12px;">
            {{--                                                        {{$place->phone}}--}}
                                                                0987654
            ...
            {{--                                            @endif--}}
            {{--                                            @if(!empty($place->site))--}}
                                                        <div class="blEntry website full-width rtl" style="display: block">
                                                            <span class="ui_icon laptop"></span>
                                                            <?php
                                                            //if (strpos($place->site, 'http') === false)
                                                            //  $place->site = 'http://' . $place->site;
        ...
        {{--                                                        href="{{$place->site}}" {{($config->externalSiteNoFollow) ? 'rel="nofollow"' : ''}}>--}}
                                                                <span style="font-size: 12px;">
                                                                    kljashdlkjashkdljhaskl
        {{--                                                                {{$place->site}}--}}
                                                                    </span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <button class="souvenirProviderPageAccess">مشاهده صفحه</button>
                                                    <button class="souvenirProviderSendMsg">ارسال پیام</button>
                                                </div>
                                                <div class="col-xs-3 right souvenirProviderDetailsMainDiv">
                                                    <div class="souvenirProviderExp inline-block full-width">
                                                        <center class="inline-block full-width">
                            ...
                            <div class="ppr_rup ppr_priv_location_nearby">
                                <div class="nearbyContainer outerShell block_wrap">
                                    <div class="block_header">
                                        <h3 class="block_title">سوغات‌های مشابه</h3>
                                    </div>
                        ...
                        <div class="content_column ui_column is-12">
                            <div class="ppr_rup ppr_priv_location_nearby">
                                <div class="nearbyContainer outerShell block_wrap tourQualityFeedbackInstructions" >
                                    <div class="block_header">
                                        <h3 class="block_title">مرامنامه کیفی شازده مسافر</h3>
                                    </div>
