...
@section('header')
    ...
    <link rel="stylesheet" href="{{URL::asset('css/theme2/providerDetails.css?v=1')}}">
    {{--<link rel="stylesheet" href="{{URL::asset('css/theme2/hotelDetail.css?v=1')}}">--}}
...
@section('main')
    ...
    <div class="ppr_rup ppr_priv_hr_atf_north_star_nostalgic" style="background: #e5e5e5; position: relative;">
            ...
            <div class="atf_header ui_container is-mobile full_width" style="position: relative;">
                ...
                <div class="ppr_rup ppr_priv_location_detail_header" style="position: relative;">
                    ...
                    <div style="position: relative">
                        ...
                        <div class="prw_rup prw_common_atf_header_bl headerBL" style="width: 20%">
                            <div class="providerHeaderDetailsRow full-width">
                                <div class="inline-block col-xs-6" onclick="showExtendedMap()">
                                    <span class="street-address">استان: </span>
                                    <span>استان</span>
                                </div>
                                {{--@if(!empty($place->phone))--}}
                                <div class="inline-block col-xs-6">
                                    <span>شهر:</span>
                                    <span>شهر</span>
                                </div>
                                {{--@endif--}}
                ...
                <div class="atf_meta_and_photos ui_container is-mobile easyClear" style="position: relative;">
                    ...
                    <div id="bestPriceRezerved" class="meta"
                        ...
                        <div id="targetHelp_9" class="targets" style="float: left">
                            ...
                            <div class="meta_inner providerGeneralDetails">
                                <div class="ppr_rup ppr_priv_hr_atf_north_star_traveler_info_nostalgic">
                                    <div class="metaDatePicker easyClear">
                                        ...
                                        <div class="offerBox" id="tourDetailsBottomBox">
                                            <div class="providerDetailsDiv col-xs-12">
                                                <div class=" inline-block full-width">
                                                    <div class="providerPic circleBase type2"></div>
                                                    <center class="providerName">
                                                        <div class="full-width">محمد محمدی</div>
                                                        {{--<div class="full-width">ستاره</div>--}}
                                                        <div class="prw_rup prw_common_bubble_rating overallBubbleRating full-width"
                                                             style="float: right;">
                                                        <span class="ui_bubble_rating bubble_50" style="font-size:20px;"
                                                ...
                                                <button class="providerSendMsg">ارسال پیام</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="prw_rup prw_hotels_flexible_album_thumb tile">
                                            <div class="albumThumbnail">
                                                ...
                                                <div onclick="getPhotos(-2)" class="albumInfo">
                                                    <span class="ui_icon camera">&nbsp;</span>عکس های سایت
                                                    {{--                                                        {{$sitePhotos}}--}}
                                                </div>
                                                {{--                                                @else--}}
                                                <div class="albumInfo">
                    ...
                    {{--                                @endif--}}
                                                ...
                                                <div class="albumInfo">
                                                    ...
                                                    <span class="ui_icon camera">&nbsp;</span>عکس های کاربران
                                                    {{--                                                    {{$userPhotos}}--}}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tileWrap"
                                         {{--                                         onclick="document.location.href = '{{route('video360')}}'"--}}
                                         style="height:33.333332%;">
                                        <div class="prw_rup prw_hotels_flexible_album_thumb tile">
                                            <div class="albumThumbnail">
                                                <div class="prw_rup prw_common_centered_image">
                                                    <span class="imgWrap " style="max-width:200px;max-height:113px;">
                                                        <img src="https://static.tacdn.com/img2/x.gif"
                                                             class="centeredImg" style=" min-width:113px; "
                                                             width="100%"/>
                                                    </span>
                                                </div>
                                                <div class="albumInfo">
                                                    <span class="ui_icon camera">&nbsp;</span>محتواهای تعاملی
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="helpSpan_10" class="helpSpans hidden row">
                                ...
                                <button data-val="10" class="btn btn-success nextBtnsHelp" id="nextBtnHelp_10">بعدی
                                </button>
                                <button data-val="10" class="btn btn-primary backBtnsHelp" id="backBtnHelp_10">قبلی
                                </button>
                                <button class="btn btn-danger exitBtnHelp">خروج</button>
                            </div>
                        </div>
        ...
        <div id="MAINWRAP"
            ...
            <div id="MAIN" class="Hotel_Review prodp13n_jfy_overflow_visible" style="position: relative;">
                <div id="BODYCON" ng-app="mainApp"
                    ...
                    <div style="height: 90px;background-color: #e5e5e5;"></div>
                        ...
                        <div id="introduction" class="ppr_rup ppr_priv_location_detail_overview">
                            <div class="block_wrap" data-tab="TABS_OVERVIEW">
                                ...
                                <div class="overviewContent">
                                    ...
                                    <div class="ui_columns is-multiline is-mobile reviewsAndDetails providerReviewsAndDetails"
                                         style="direction: ltr;">
                                        <div class="ui_column is-6 details">
                                            <div style="direction: rtl;" class="providerDetailsInformation">
                                                <div>
                                                    <span class="green">نام:</span>
                                                    <span>محمد محمدی</span>
                                                </div>
                                                <div>
                                                    <span>حوزه فعالیت:</span>
                                                    <span>محصولات بومی. ارائه خدمات سفر</span>
                                                </div>
                                                <div>
                                                    <span>تعداد محصولات/خدمات ارائه شده:</span>
                                                    <span>10 محصول</span>
                                                </div>
                                                <div>
                                                    <span class="inline-block">بازدید صفحه:</span>
                                                    <span>300 نفر</span>
                                                    <span class="inline-block">مخاطبان:</span>
                                                    <span>200 نفر</span>
                                                </div>
                                                <div>
                                                    <span>شماره مجوز:</span>
                                                    <span>2031 مرجع میراث فرهنگی</span>
                                                </div>
                                                <div>
                                                    <span>تاریخ شروع فعالیت:</span>
                                                    <span>21 شهریور ماه 98</span>
                                                </div>
                                                <div>
                                                    <span>تاریخ شروع صفحه:</span>
                                                    <span>21 شهریور 98</span>
                                                </div>
                                                <div>
...
{{--                                                        {{ceil($rates[4] * 100 / $total)}}--}}
                                                        %</span>
                                                        <span class="row_bar row_cell">
                                                        <span class="bar">
                                                            <span class="fill"
{{--                                                                  style="width: {{ceil($rates[4] * 100 / $total)}}%;"--}}
                                                            >
                                                            </span>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <span class="row_count row_cell">
{{--                                                        {{ceil($rates[3] * 100 / $total)}}--}}
                                                        %</span>
                                                        <span class="row_bar row_cell">
                                                        <span class="bar">
                                                            <span class="fill"
{{--                                                                  style="width:{{ceil($rates[3] * 100 / $total)}}%;"--}}
                                                            >
                                                            </span>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <li class="chart_row clickable">
                                                    <span class="row_count row_cell">
{{--                                                        {{ceil($rates[2] * 100 / $total)}}--}}
                                                        %</span>
                                                        <span class="row_bar row_cell">
                                                        <span class="bar">
                                                            <span class="fill"
{{--                                                                  style="width:{{ceil($rates[2] * 100 / $total)}}%;"--}}
                                                            >
                                                            </span>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <li class="chart_row clickable">
                                                    <span class="row_count row_cell">
{{--                                                        {{ceil($rates[1] * 100 / $total)}}--}}
                                                        %</span>
                                                        <span class="row_bar row_cell">
                                                        <span class="bar">
                                                            <span class="fill"
{{--                                                                  style="width:{{ceil($rates[1] * 100 / $total)}}%;"--}}
                                                            >
                                                            </span>
                                                        </span>
                                                    </span>
                                                    ...
                                                    <li class="chart_row">
                                                    <span class="row_count row_cell">
{{--                                                        {{ceil($rates[0] * 100 / $total)}}--}}
                                                        %</span>
                                                        <span class="row_bar row_cell">
                                                        <span class="bar">
                                                            <span class="fill"
{{--                                                                  style="width:{{ceil($rates[0] * 100 / $total)}}%;"--}}
                                                            >
                                                            </span>
                                                        </span>
                                                    </span>
...
{{--                                                            {{$place->phone}}--}}
                                    ...
                                    <div class="ui_column  is-12 providerStory">
                                        <div id="photosDiv" class="ppr_rup ppr_priv_hr_btf_north_star_photos"
                                            ...
                                            <div class="block_wrap" style="position: relative;">
                                                <div class="block_header" data-tab="TABS_PHOTOS" style="position: relative;">
                                                    <h3 class="block_title">داستان من</h3>
                                                </div>
                                                <div class="ui_column is-12 inline-block" style="padding: 0; margin-bottom: 30px">
                                                    <div class="ui_column col-xs-9 inline-block providerStoryContent">
                                                        لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                                                        استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در
                                                        ستون و سطر آنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و
                                                        کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می‌باشد.
                                                    </div>
                                                    <div class="ui_column providerStoryMenu inline-block">
                                                        <div>
                                                            داستان من
                                                        </div>
                                                        <div>
                    ...
                    <div class="hr_btf_wrap providerServicesMainDiv" style="position: relative;">
                        <h3 class="inline-block full-width providerServicesTitle">خدمات من</h3>
                        <div class="full-width inline-block">
                            <div class="col-xs-3">
                                <div class="providerDetailsServices inline-block full-width">
                                    <div class="providerDetailsPicServices circleBase type2"></div>
                                    <center class="providerDetailsNameServices">
                            ...
                            <div class="col-xs-3">
                                <div class="carousel_wrapper ui_column">
                                    <div class="prw_rup prw_common_mercury_photo_carousel carousel_outer">
                                        <div class="carousel bignav" style="max-height: 150px;">
                                            <div class="carousel-images carousel_images_footer"
                                                 style="height: 100%">
                                                <img src="../public/images/soghat.jpg">
...
{{--                                                </div>--}}
                        ...
                        <div class="full-width inline-block">
                            ...
                            <div class="col-xs-3">
                                <div class="carousel_wrapper ui_column is-12">
                                    <div class="prw_rup prw_common_mercury_photo_carousel carousel_outer">
                                        <div class="carousel bignav" style="max-height: 424px;">
                                            <div class="carousel-images carousel_images_footer"
                                                 style="height: 100%">
