...
function mouseMoveRate(event, opinionId) {
    ...
    oldRate = 0;
    if($("#opinion_" + opinionId).hasClass("bubble_50"))
        oldRate = 5;
    else if($("#opinion_" + opinionId).hasClass("bubble_40"))
        oldRate = 4;
    else if($("#opinion_" + opinionId).hasClass("bubble_30"))
        oldRate = 3;
    else if($("#opinion_" + opinionId).hasClass("bubble_20"))
        oldRate = 2;
    else if($("#opinion_" + opinionId).hasClass("bubble_10"))
        oldRate = 1;
    ...
    $("#opinion_" + opinionId).addClass("bubble_" + i + "0");
    $("#ratingText_" + opinionId).empty();
    $("#ratingText_" + opinionId).append(descriptions[i]);
}
...
function mouseLeaveRate(opinionId) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#opinion_" + opinionId).removeClass("bubble_00");
            $("#opinion_" + opinionId).removeClass("bubble_10");
            $("#opinion_" + opinionId).removeClass("bubble_20");
            $("#opinion_" + opinionId).removeClass("bubble_30");
            $("#opinion_" + opinionId).removeClass("bubble_40");
            $("#opinion_" + opinionId).removeClass("bubble_50");
            $("#opinion_" + opinionId).addClass("bubble_" + response + "0");
            $("#ratingText_" + opinionId).empty();
            $("#ratingText_" + opinionId).append(descriptions[response]);
        }
    });
