...
Route::get('gardeshname2/{page?}', function($page = 1){
	...
	$posts = DB::table('post')->join('favoritePost', 'postId', 'post.id')->where('date', '<=', $today)->select('post.categoryColor', 'post.backColor', 'post.color', 'post.title', 'post.seen', 'post.created_at', 'post.pic', 'post.alt', 'post.category')->take(5)->get();
	...
	$bannerPosts = DB::table('post')->join('bannerPosts', 'postId', 'post.id')->where('date', '<=', $today)->select('post.categoryColor', 'post.backColor', 'post.color', 'post.title', 'post.seen', 'post.created_at', 'post.pic', 'post.alt', 'post.category')->take(5)->get();
	...
	$recentlyPosts = \App\models\Post::where('date', '<=', $today)->select('categoryColor', 'backColor', 'color', 'title', 'seen', 'created_at', 'pic', 'alt', 'category')->orderBy('created_at', 'DESC')->take(5)->get();
	...
	$mostSeenPosts = \App\models\Post::where('date', '<=', $today)->select('categoryColor', 'backColor', 'color', 'title', 'seen', 'created_at', 'pic', 'alt', 'category')->orderBy('seen', 'DESC')->take(5)->get();
	...
	$skip = ($page - 1) * 5;
	$allPosts = \App\models\Post::where('date', '<=', $today)->select('categoryColor', 'backColor', 'color', 'title', 'seen', 'description', 'created_at', 'pic', 'alt', 'category')->orderBy('created_at', 'DESC')->skip($skip)->take(5)->get();
...
Route::get('/souvenir-details', function(){
    return view('souvenir-details');
});

Route::get('/provider-details2', function(){
