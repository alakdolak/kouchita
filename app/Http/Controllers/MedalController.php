...
class MedalController extends Controller {
    ...
    public function showMedals() {
        ...
        foreach($medals as $medal) {
            if($medal->kindPlaceId != -1) {
                $arr[$counter++] = ['name' => $medal->name, 'id' => $medal->id,
                    ...
                    "activity" => Activity::whereId($medal->activityId)->name, 'floor' => $medal->floor,
        ...
        return view("medals", array('medals' => $arr, 'mode2' => 'see'));
    ...
    public function addMedal() {
        ...
        if(isset($_POST["addMedal"]) && isset($_POST["medalName"]) && isset($_POST["kindPlaceId"]) &&
            ...
            $targetFile = __DIR__ . "/../../../../assets/badges/" . $file["name"];
        ...
        return view('medals', array('medals' => $arr, 'mode2' => 'add', 'msg' => $err, 'places' => $places,
    ...
    public function opOnMedal() {
        ...
        if(isset($_POST["deleteMedal"])) {
            ...
            try {
                ...
                if(file_exists(__DIR__ . '/../../../public/badges/' . $medal->pic_1))
                    unlink(__DIR__ . '/../../../public/badges/' . $medal->pic_1);

                if(file_exists(__DIR__ . '/../../../public/badges/' . $medal->pic_2))
                    unlink(__DIR__ . '/../../../public/badges/' . $medal->pic_2);
        ...
        return Redirect::to(route('medals'));
